...
liEl.style.backgroundColor = 'rgb(251,146,60)';
...
h3El.style.fontWeight = '150px';
h3El.style.fontSize = '30px';
h3El.style.padding = "10px";
h3El.style.color = 'rgb(59,130,246)';
...
span2El.style.fontSize = '30px';
span2El.style.fontWeight = '30px';
span2El.innerHTML = `${product.Price}` + '<br>';

const smallEl = document.createElement('small');
// smallEl.style.color = 'rgb(251,146,60)';
smallEl.style.color = 'black';
